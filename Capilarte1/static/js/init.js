...
var WidgetHelper = (function () {
  ...
  WhWidgetSendButton = (function () {
    function a() {}
    return (
      (a.getMetricsIframeId = function () {
        return "iframe-metrics-" + a.widgetWrapperId;
      }),
      (a.checkParams = function (a, b, c) {
        return (
          !(!a || 0 === String(a).length) && !(!b || 0 === String(b).length)
        );
      }),
      ...
      (a.addMetricsIframe = function (b, c, d) {
        ...
        WidgetDOM.addMetricsIframe(
          c + "//" + b + "/widget/metrics?" + WidgetHelper.encodeGetParams(e),
          a.getMetricsIframeId()
        );
      }),
      (a.clear = function () {
      ...
      (a.init = function (b, c, d) {
        if (
          ((b = b.replace("whatshelp.io", "getbutton.io")),
          (b = b.replace("wh.test", "getbutton.test")),
          a.checkParams(b, c, d))
        ) {
          a.clear();
          var e = {
          ...
          (d = WidgetInitializer.checkAndClearProOptions(
            d,
            window.location.hostname
          )),
            (WidgetDetect.isMobile() &&
              d.hasOwnProperty("mobile") &&
              !1 === d.mobile) ||
              (!WidgetDetect.isMobile() &&
                d.hasOwnProperty("desktop") &&
                !1 === d.desktop) ||
              (WidgetInitializer.widgetInitialize("container", e, d),
              setTimeout(function () {
                a.prepareForSmallScreen();
              }, 3e3),
              window.addEventListener("resize", function () {
                return a.prepareForSmallScreen();
              }));
        }
      }),
      (a.prepareForSmallScreen = function () {
        for (
          var a = {
              name: "parentWindow",
              data: {
                width: parent.window.screen.width,
                height: parent.window.screen.height,
              },
            },
            b = 0;
          b < window.frames.length;
          b++
        )
          window.frames[b].postMessage(JSON.stringify(a), "*");
      }),
      a
    );
  })();
...
var WidgetSendButtonContainer = (function () {
  function a(a, b) {
    var c = this;
    (this.container = null),
      (this.onPostMessage = function (a) {
        if (a.origin.replace(/^https?:\/\//, "") === "widget." + c.params.host)
          try {
            var b = JSON.parse(a.data);
            if (null === b || !b.hasOwnProperty("name")) return;
            "wh-resize-widget" === b.name && c.onPostMessageResize(b),
              "wh-change-url" === b.name &&
                c.onPostMessageClickButton(b, c.onPostMessageChangeUrl),
              "wh-open-tab" === b.name &&
                (c.onPostMessageClickButton(b), c.onPostMessageOpenTab(b)),
              "wh-click-button" === b.name && c.onPostMessageClickButton(b);
          } catch (a) {}
      }),
      (this.params = a),
      (this.options = b),
      this.addStyles(),
      this.buildWidget(),
      window.addEventListener("message", this.onPostMessage, !1);
  }
  return (
    ...
    (a.prototype.onPostMessageResize = function (a) {
      ...
      if (b) {
        var c = b.clientWidth !== a.width,
          d = b.classList.contains("wh-widget-right");
        if (
          !WidgetDetect.isMobile() &&
          WidgetDetect.isChromeBasedBrowser() &&
          c &&
          d &&
          a.width < 290
        )
          return (
            (b.style.width = "290px"),
            void (b.style.height = a.height.toString() + "px")
          );
        (b.style.width = a.width.toString() + "px"),
          (b.style.height = a.height.toString() + "px");
      }
    }),
    ...
    (a.prototype.buildWidget = function () {
      ...
      (b.id = a.getIframeId(this.params.wrapperId)),
        b.setAttribute("src", this.getWidgetUrl()),
        b.setAttribute("name", "IGetButton");
      var c = WidgetDOM.addDiv(this.params.wrapperId, b, !1);
      if (
        (this.options.shift_horizontal > 0 &&
          (c.style[this.options.position] =
            this.options.shift_horizontal + "px"),
        this.options.shift_vertical > 0)
      ) {
        var d = c.getAttribute("style");
        null === d && (d = ""),
          c.setAttribute(
            "style",
            d + " bottom: " + this.options.shift_vertical + "px !important;"
          );
      }
      WidgetDOM.setClass(c, "wh-widget-" + this.options.position),
        (this.container = c),
        this.params.isMobile &&
          !WidgetDOM.isViewportExist() &&
    ...
    (a.prototype.getWidgetUrl = function () {
      var b = 0;
      Cookie.check(a.cookieName) ||
        ((b = 1), Cookie.set(a.cookieName, "1", a.cookieExpire));
      ...
      return (
        ...
        this.params.host +
        "/widget/wSendButton?" +
        WidgetHelper.encodeGetParams(c)
      );
    }),
...
(WidgetSendButtonContainer.cookieName = "wh-widget-cookie"),
  (WidgetSendButtonContainer.cookieExpire = 86400);
